...
use Napp\Core\Dbal\Criteria\WithAttributeInValuesCriterion;
use Napp\Core\Dbal\Tests\TestCase;

class WithAttributeInValueCriterionTest extends TestCase
{
    /**
     * @var WithAttributeInValuesCriterion
     */
    protected $criterion;
    ...
    public function setUp(): void
    {
        ...
        $this->criterion = new WithAttributeInValuesCriterion('email', ['john@example.com']);
    }
